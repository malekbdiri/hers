...
<head>
    ...
    <title>WonderWoman: Creative Admin Dashboard</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i> Sales <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout"></i> Admin <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <!-- <ul>
                    ...
                    <li><a class="sidebar-sub-toggle" ><i class="ti-panel"></i> Produits <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="listproduit.php">Edit Produit</a></li>
                            <li><a href="listCommande.php">commandes</a></li>
                    ...
                    <!--li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Commande <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="table-basic.html">Basic</a></li>

                            <li><a href="table-export.php">Cart Items</a></li>
                            <li><a href="table-row-select.php">Orders</a></li>
                            <li><a href="table-jsgrid.html">Editable </a></li>
                        </ul>
                    </li-->
                    <li><a class="sidebar-sub-toggle"><i class="ti-heart"></i> Forum <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="font-themify.html">Tableau1</a></li>
                        </ul>
                        <ul>
                            <li><a href="font-themify.html">Tableau2</a></li>
                        </ul>
                    </li>
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Relcamation <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <!-- <li><a href="gmaps.html">Basic</a></li>-->
                            <li><a href="afficherListeReclamation.php">Reclamation</a></li>
                        </ul>
                        <ul>
                            <li><a href="afficherReponse.php">Reponse</a></li>
                        </ul>
                    </li>
                    <li><a class="sidebar-sub-toggle"><i class="ti-map"></i> Rendez-vous <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>

                        <ul>
                            <li>
                                <a href="ajouterLivreur.php">Tableau 1 </a>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <a href="afficherLivreur.php">Tableau 2</a>
                            </li>
                        </ul>
                        <li><a class="sidebar-sub-toggle"><i class="ti-map"></i> Reclamation <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
