        ...
        foreach($reponse as $reponse) 
         {
            ?> 
               ...
               <option value=<?= $reponse['idreponse']?>> 
          <?= $reponse['idclient']?> 
      </option> 
            <?php 
           } ?>
        ...
        <div class="row">
          ...
          <div class="row">
           ...
           <!--div class="row form-group">
             ...
             <div class="col-md-6 mb-3 mb-md-0">          
              <input type="text" class="form-control" name="idclient" id="idclient" placeholder="idclient" data-rule="minlen:4" data-msg="Please enter at least 4 chars" onkeyup="idclientValidation()" required >
              <div>
            <p style="color :red" id="idclientr"></p>
             ...
             <div class="col-md-6">
               ...
               <input type="number" class="form-control" name="reference" id="reference" placeholder="Reference" data-rule="reference" min="2"max="6" data-msg="Entrez Reference"  onkeyup="referenceValidation()">
               <div class="validate"></div>
...
<br>  </br>
         ...
         <br> </br>
         <div class="text-center"><button type="submit"  value="Submit" onclick="referenceValidation()">Send Message</button></div>
